...
if __name__ == '__main__':
    ...
    save_dir = Path("saved_models") / TICKER / "xgb_reg_baseline"
    ...
    price_fig.add_trace(go.Scatter(
        x=plot_test.index, y=plot_pred, mode="lines", name="XGBoost Predicted",
    ...
    price_fig.update_layout(
        title="XGBoost: Predictions vs Actual Price Action (Last 6 Months)",
        xaxis_title="Date", yaxis_title="Price (Rs)",
        template="plotly_white", xaxis_rangeslider_visible=False,
    )
    price_fig.write_html(f"plot_xgb_regression_candlestick_{TICKER}.html")
    ...
    scatter_fig.write_html(f"plot_xgb_regression_scatter_{TICKER}.html")
